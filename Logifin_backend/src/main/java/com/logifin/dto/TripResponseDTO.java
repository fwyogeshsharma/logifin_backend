...
@AllArgsConstructor
@Builder
@Schema(description = "Response payload containing trip details")
public class TripResponseDTO {

    @Schema(description = "Trip ID", example = "1")
    private Long id;

    @Schema(description = "Unique E-way Bill Number", example = "EWB123456789")
    private String ewayBillNumber;

    @Schema(description = "Whether E-way Bill image is present", example = "true")
    private Boolean hasEwayBillImage;

    @Schema(description = "E-way Bill image content type", example = "image/png")
